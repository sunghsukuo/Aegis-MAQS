...
def get_etf_holdings(etf_ticker: str, region: str = None, macro_regime: str = None) -> list:
    """
    ...
    return screener.screen_stocks(etf_ticker, region=region, macro_regime=macro_regime)
